            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        ...
                        ?>
                        <div class="card-body">
                            <form action="edit_siswa_update" method="post" autocomplete="off">
                                <input type="hidden" name="id" value="<?php echo $result['id']; ?>">
                                <div class="form-group">
                                    <label for="nama_siswa">Nama Siswa</label>
                                    <input type="text" name="nama_siswa" id="nama_siswa"
                                    value="<?= $result['nama_siswa'] ?>" class="form-control" placeholder=" siswa">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="kelas_id" id="kelas_id" class="form-control">
                                        ...
                                        ?>
                                        <option <?= $result['kelas_id'] == $data['id'] ? 'selected':''  ?> value="<?= $data['id'] ?>"><?= $data['nama_kelas'] ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div>
